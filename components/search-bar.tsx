...
export default function SearchBar({
  ...
  // 🔥 ДОБАВИЛИ ТОЛЬКО ЭТО (toggle для "Рядом")
      ...
      <div className="flex items-center gap-2">
          ...
          >
            {showSearch ? (
              <>
                ...
                {/* 🔥 КРЕСТИК (только визуально улучшен, логика та же) */}
                <button
                  onClick={() => {
                    onSearchChange("");
                    onToggleSearch();
        ...
        {!showSearch && (
          <div className="flex items-center gap-2">
            ...
            {/* 🔥 РЯДОМ — TOGGLE (минимальное изменение) */}
            <button
              onClick={() => {
                setNearActive((prev) => !prev);
                onNear();
              }}
              className={`
                flex
